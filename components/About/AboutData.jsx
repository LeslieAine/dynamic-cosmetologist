...
export const aboutData = {
    mainData: {
        ...
        // jobTitle: "UI & UX Designer. Photographer",
        // description: "Perfecting our craft for years to ensure you look your best every time",
        yearsOfExperience: "12",
        hoursOfWorking: "20",
        projectsDone: "90",
        // typewriter: ['Hi There!', 'I\'m Christina'],
    },
    skills: [
        {
            id: 1,
