...
const Testimonial = ({reviews, color}) => {
    ...
    return (
        <div className="section-box mt-4" id="testimonial" style={{ border: `3px solid ${color}`, borderRadius: '0.8em' }}>
                    ...
                    <SwiperSlide key={index}>
                        ...
                        <div className="d-flex align-items-center mt-3">
                            <div className="d-inline-block me-3">
                                <Image className="img-mask-avatar-sm" src={TestimonialAvatar} alt={item.name} placeholder="blur" />
                            </div>
